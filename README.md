...
```bash
pip install git+https://github.com/gibbster/judgment-base-agent.git
```

Or with uv:

```bash
uv add git+https://github.com/gibbster/judgment-base-agent.git
```

Or clone to run the **5 interactive `adk web` examples** and **live latency benchmarks** locally:

```bash
git clone https://github.com/gibbster/judgment-base-agent.git
